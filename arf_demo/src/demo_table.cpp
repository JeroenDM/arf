...
void Demo1::createGraphData(Robot& robot)
{
  ...
  tool0_to_tool_tip = Eigen::Isometry3d::Identity() *
          Eigen::AngleAxisd(-1.57079632679 , Eigen::Vector3d::UnitY());

  tool0_to_tool_tip = tool0_to_tool_tip * Eigen::Translation3d(0.315, 0.0, 0.035) *
          Eigen::AngleAxisd(0.0, Eigen::Vector3d::UnitX()) *
          Eigen::AngleAxisd(2.3560569232 , Eigen::Vector3d::UnitY()) *
